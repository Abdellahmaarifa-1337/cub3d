...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/16 17:58:02 by mkabissi          #+#    #+#             */
/*   Updated: 2022/11/17 12:02:04 by mkabissi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (cub->map.data[(int)((cub->p.y + dy) /
		(float)CELL)][(int)((cub->p.x + dx) / (float)CELL)] == '1'
		|| (cub->map.data[(int)(cub->p.y / (float)CELL)][(int)((cub->p.x + dx) /
		(float)CELL)] == '1'
		&& cub->map.data[(int)((cub->p.y + dy) / (float)CELL)][(int)(cub->p.x /
		(float)CELL)] == '1'))
		return (1);
	return (0);
}
